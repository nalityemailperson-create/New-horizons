...
local function downloadFile(path, func)
	...
	if not isfile(path) then
		local suc, res = pcall(function() return pistonwareHttpGet('https://raw.githubusercontent.com/nalityemailperson-create/New-horizons/main/pistonware-full/'..select(1, path:gsub('pistonware/', '')), true) end)
